package com.hari.springcore.lc.annotations;
...
public class Test {
	...
	public static void main(String[] args) {
		AbstractApplicationContext context = new ClassPathXmlApplicationContext("com/hari/springcore/lc/annotations/config.xml");
